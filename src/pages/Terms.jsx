        ...
        >
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <Section title="1. Introduction and Acceptance">
                    ...
                    <p>These Terms and Conditions ("Terms") constitute a legally binding agreement between you ("User," "you," or "your") and LUMON INDUSTRIES, a French simplified joint-stock company (société par actions simplifiée), registered under number 94113277100010, with its registered office at QUAI DE RIVE NEUVE, 13007 MARSEILLE, operator of the Fantazia.ai platform ("Lumon Industries," "we," "us," or "our").</p>
                ...
                <Section title="3. Account Registration">
                    ...
                    <p>We reserve the right to suspend or terminate your account if you violate these Terms, engage in fraudulent or illegal activity, use the Service in a manner that could harm Lumon Industries or other users, or fail to pay applicable fees.</p>
                </Section>
                ...
                <Section title="5. Intellectual Property">
                    <h3 className="font-medium text-ink mt-4 mb-2">5.1 Lumon Industries Property</h3>
                    <p>The Service, including all software, AI models, algorithms, user interface, and underlying technology, is owned by Lumon Industries and protected by intellectual property laws. Nothing in these Terms grants you any right to use Fantazia trademarks, logos, or branding.</p>

                    <h3 className="font-medium text-ink mt-6 mb-2">5.2 Your Content</h3>
                    <p>You retain ownership of any content you upload to the Service (prompts, images, etc.). By uploading content, you grant Lumon Industries a worldwide, non-exclusive, royalty-free license to use, process, and store such content solely for the purpose of providing the Service to you.</p>
                    ...
                    <p><span className="font-medium">Lumon Industries Rights:</span> Lumon Industries does not claim ownership of your Generated Content. However, we retain the right to store technical copies as necessary for service delivery and to use anonymized, aggregated data derived from usage patterns for service improvement.</p>
                    ...
                    <p>If you provide feedback, suggestions, or ideas about the Service, you grant Lumon Industries an unlimited, irrevocable, perpetual license to use such feedback for any purpose without compensation to you.</p>
                </Section>
                ...
                <Section title="6. AI and Generated Content">
                    ...
                    <p>You are responsible for reviewing all generated content before use or distribution. Lumon Industries does not pre-screen AI-generated content and is not responsible for any issues arising from your use of such content.</p>
                ...
                <Section title="9. Disclaimers and Limitations of Liability">
                    ...
                    <p className="uppercase text-xs font-bold tracking-wider mb-2">TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, LUMON INDUSTRIES SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING BUT NOT LIMITED TO LOSS OF PROFITS, DATA, USE, OR GOODWILL.</p>
                    ...
                    <p>This limitation applies regardless of the theory of liability and even if Lumon Industries has been advised of the possibility of such damages.</p>
                ...
                <Section title="11. Term and Termination">
                    ...
                    <h3 className="font-medium text-ink mt-6 mb-2">11.3 Termination by Lumon Industries</h3>
                ...
                <Section title="13. General Provisions">
                    ...
                    <p>These Terms, together with the Privacy Policy and any additional terms you agree to, constitute the entire agreement between you and Lumon Industries regarding the Service.</p>
